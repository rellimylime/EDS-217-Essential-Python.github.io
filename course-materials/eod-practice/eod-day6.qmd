...
# Dictionary of countries and their 1990 (or close) population data
# Note: Some countries' data are from years other than 1990 due to their formation after 1990
population_data = {
    'Switzerland': 6674000,
    'Netherlands': 14952000,
    'Belgium': 9967379,
    'Germany': 79433029,
    'France': 56707000,
    'Luxembourg': 381900,
    'Italy': 56719240,
    'Denmark': 5141115,
    'United Kingdom': 57247586,
    'Austria': 7677850,
    'Sweden': 8559000,
    'Monaco': 29972,
    'Norway': 4241473,
    'Yugoslavia': 23818000,  # 1990 data, before breakup
    'Spain': 39202525,
    'Finland': 4986431,
    'Portugal': 9983218,
    'Ireland': 3515000,
    ...
    'Cyprus': 766615,
    'Iceland': 255866,
    'Croatia': 4776374,  # 1991 data
    'Bosnia & Herzegovina': 4377033,  # 1991 data
    'Slovenia': 1999945,  # 1991 data
    'Poland': 38110782,
    'Hungary': 10373988,
    'Russia': 148005704,  # 1991 data
    'Slovakia': 5298288,  # 1991 data
    'Romania': 23489000,
    'Estonia': 1570599,  # 1991 data
    'Lithuania': 3704134,  # 1991 data
    'North Macedonia': 1996869,  # 1991 data
    'Latvia': 2658161,  # 1991 data
    'Ukraine': 51944000,  # 1991 data
    'Serbia & Montenegro': 9791475,  # 1991 data, combined population
    'Albania': 3286070,
    'Andorra': 54507,
    'Belarus': 10189000,  # 1991 data
    'Moldova': 4364813,  # 1991 data
    'Bulgaria': 8718289,
    'Armenia': 3574480,  # 1991 data
    'Serbia': 7824000,  # 1991 data
    'Georgia': 5464000,  # 1991 data
    'Montenegro': 615035,  # 1991 data
    'Czech Republic': 10362000,  # 1991 data
    'Azerbaijan': 7218500,  # 1991 data
    'San Marino': 23186,
    'Australia': 17065100
}

# Create a DataFrame
population_df = pd.DataFrame(list(population_data.items()), columns=['country_name', 'population'])
