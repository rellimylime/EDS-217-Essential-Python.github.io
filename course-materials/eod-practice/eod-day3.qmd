...
::: {.callout-important}
## Sam TODO
TODO: fork & update this repo (linked below) <https://github.com/allisonhorst/eds212-sir-ode>
:::

a. Fork and clone [this repo](https://github.com/allisonhorst/eds212-sir-ode), which contains an R Markdown document with code to numerically solve the SIR equations, to create a version-controlled project
