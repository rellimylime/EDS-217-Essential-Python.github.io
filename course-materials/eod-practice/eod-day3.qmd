...
a. Fork and clone [this repo](https://github.com/samanthacsik/SIR-ODE-example), which contains an R Markdown document with code to numerically solve the SIR equations, to create a version-controlled project
