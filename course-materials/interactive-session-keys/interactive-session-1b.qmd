...
Consider how you'll want to organize all your MEDS projects / code. This is totally up to you, though one suggestion is to create a `MEDS/` folder in your computer's root directory, then a folder for each course (e.g. `EDS-212`), *then* add your R Project (e.g. `eds212-day1b`) inside that course folder. 
:::
