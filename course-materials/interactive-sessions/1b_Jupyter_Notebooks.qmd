...
- **Keyboard Shortcuts**: Familiarize yourself with keyboard shortcuts to speed up your workflow. You can view shortcuts by clicking `Help > Keyboard Shortcuts`. You can also refer to our class [Jupyter Keyboard Shortcuts Cheatsheet](../cheatsheets/JupyterLab.ipynb)
