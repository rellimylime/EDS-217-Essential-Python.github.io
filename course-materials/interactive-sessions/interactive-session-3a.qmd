...
#| include: false
# # Create a time sequence ----
# time_seq2 <- seq(from = 0, to = 0.2, by = 0.1)
# 
# # Find the approximate the solution using `deSolve::ode()` ----
# approx_df_example2 <- ode(y = init_cond_example,
#                          times = time_seq, 
#                          func = df_equation_example, 
#                          parms = parameter_example)
# 
...
# # Plot it ----
# ggplot() +
#   geom_point(data = approx_df_example, aes(x = time, y = C), size = 0.1, color = "blue") +
#   geom_point(data = approx_df_example2, aes(x = time, y = C), size = 0.1)
```
...
a. Visit: <https://github.com/samanthacsik/lotka-volterra-example>
