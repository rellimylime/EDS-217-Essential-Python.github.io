...
- Create a new R Project and name it `eds212-day2a-GHpractice`
- Add a new Quarto document
- Render (it'll prompt you to name / save the file first; I'll name mine `vc-gh.qmd`)
...
#| out-width: "100%"
#| fig-align: "center"
knitr::include_graphics("images/git-repo-diagram2.png")
```
:::
