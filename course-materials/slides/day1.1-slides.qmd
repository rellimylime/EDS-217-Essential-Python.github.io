...
[$$x^n=x\times x\times\ x \times x...(n\space times)$$]{.body-text-l}

<br>

<!-- [Exponent warm-ups]{.body-text-m} -->

[Evaluate the following to find a value for $y$:]{.body-text-l}

<br>

[1. $y = 12-2^4$]{.body-text-l}

<br>

[2. $2y + 30=y+3^3$]{.body-text-l}
...
[Think about these statements, which all contain the same *value* of 4:]{.body-text-m}

<br>

- [There are four in the refrigerator.]{.body-text-m}

- [There are four **burritos** in the refrigerator.]{.body-text-m}

- [There are four **roaches** in the refrigerator.]{.body-text-m}

- [There are four **million dollars** in the refrigerator.]{.body-text-m}
...
[In dimensional analysis, we multiply initial units by a sequence of conversion factors to arrive at the final desired units.]{.body-text-m}

<br>

[For example, to convert $100 \frac{g}{cm^3}$ into units of $\frac{kg}{in^3}$, given that 1 cm^3^ = 0.061 in^3^.]{.body-text-m}

<br>

[$$100\frac{g}{cm^3}*\frac{1kg}{1000g}*\frac{1cm^3}{0.061in^3}=1.639\frac{kg}{in^3}$$]{.body-text-m}
...
[Practice dimensional analysis to perform the following conversions:]{.body-text-m}

<br>

[1. Convert $8.1\frac{km}{s}$ to miles per hour, given that 1 km = 0.621 miles.]{.body-text-m}

<br>

[2. Convert a mass flux of $3.2\frac{g}{min\cdot m^2}$ to $\frac{mg}{s\cdot cm^2}$.]{.body-text-m}
...
[For continuous functions, we evaluate them by plugging in variable values.]{.body-text-m} 
...
[Evaluate $g(x,t)=2.4x+0.5t^2$ at $x = 3$ and $t = 10$]{.body-text-m} 

<br>

[$g(3, 10) = 2.4(3) + 0.5(10^2)= 57.2$]{.body-text-m}  
