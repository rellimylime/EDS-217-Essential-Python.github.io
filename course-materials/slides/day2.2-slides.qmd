...
[The **Advection-Dispersion-Reaction Equation** for solute transport models the change in a solute concentration $C$ over time $t$, where groundwater is flowing in direction $x$:]{.body-text-m}
